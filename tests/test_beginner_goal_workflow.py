...
class TestGoalWorkflow(unittest.TestCase):
    ...
    def test_beginner_mode_eleven_tabs_no_etf_label(self) -> None:
        self.assertEqual(len(BEGINNER_TAB_LABELS), 11)
        self.assertIn(BEGINNER_REAL_PORTFOLIO_TAB_LABEL, BEGINNER_TAB_LABELS)
        self.assertNotIn(ETF_HOLDINGS_TAB_LABEL, BEGINNER_TAB_LABELS)
    ...
    def test_beginner_main_tab_routing_core_steps(self) -> None:
        """Regression: core workflow tabs (10) route via _MAIN_TAB_STEP_ORDER; My Portfolio is separate."""
        ...
        self.assertTrue(is_real_portfolio_tab(BEGINNER_REAL_PORTFOLIO_TAB_LABEL))
    ...
    def test_real_portfolio_tab_advanced(self) -> None:
        self.assertIn(REAL_PORTFOLIO_TAB_LABEL, ADVANCED_TAB_LABELS)
        self.assertTrue(is_real_portfolio_tab(REAL_PORTFOLIO_TAB_LABEL))
