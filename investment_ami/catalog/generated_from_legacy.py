...
_INTENT_SPECS: dict[str, dict[str, object]] = {
    ...
    "allocation_advisor": {
        "title": "Investment allocation advisor",
        "category": AmiCategory.ASSET_ALLOCATION,
        "description": "Educational guidance on how much to invest, contributions, debt vs invest, and strategy fit.",
        "engines": ("allocation_advisor",),
        "output_type": "recommendation",
        "profile": "planning",
        "legacy": "decision_support",
        "required": frozenset(),
        "optional": frozenset({"investment_plan", "plan_total_cash", "plan_emergency"}),
        "follow_up": ("cash_reserve_advisor",),
    },
    "cash_reserve_advisor": {
        "title": "Cash reserve analysis",
        "category": AmiCategory.ASSET_ALLOCATION,
        "description": "Emergency fund sizing, liquidity, and cash vs invest trade-offs.",
        "engines": ("cash_reserve_advisor",),
        "output_type": "recommendation",
        "profile": "planning",
        "legacy": "decision_support",
        "required": frozenset(),
